...
class AccountMove(models.Model):
    ...
    These are kept as placeholders to prevent Odoo Studio or custom database
    views from breaking after the migration to Delivery-based tracking.

    The Monta integration works exclusively through stock.picking (deliveries).
    No invoice hooks exist here — Odoo's default invoice/delivery flow is
